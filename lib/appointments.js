...
async function createAppointment(payload = {}) {
  ...
  const resolvedReminderOffsetMinutes = Number(reminderOffsetMinutes == null ? 10 : reminderOffsetMinutes);
  if (!Number.isFinite(resolvedReminderOffsetMinutes) || resolvedReminderOffsetMinutes < 0 || resolvedReminderOffsetMinutes > 10080) {
    throw new Error('reminderOffsetMinutes must be between 0 and 10080');
  }
